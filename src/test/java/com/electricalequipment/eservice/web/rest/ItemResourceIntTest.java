...
public class ItemResourceIntTest {
    ...
    private static final Category DEFAULT_CATEGORY = Category.PHONE;
    private static final Category UPDATED_CATEGORY = Category.COMPUTER;

    private static final Status DEFAULT_STATUS = Status.OK;
    private static final Status UPDATED_STATUS = Status.BROKEN;
